...
enum SelfTest {
    static let launchArgument = "-LibraSelfTest"

    static var isRequested: Bool {
        CommandLine.arguments.contains(launchArgument)
    }

    private static let logger = Logger(subsystem: "com.tylerabitbol.libra", category: "selftest")
    ...
    static let captureArgument = "-LibraCaptureFixtures"
