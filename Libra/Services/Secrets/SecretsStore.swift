...
enum SecretKey: String, CaseIterable, Sendable {
    ...
    var helpText: String {
        ...
        case .secOrganizationName:
            "Optional. The SEC's documented User-Agent format is \"Company Name contact@domain.com\". Leave blank to identify as \"Libra\"."
        }
    }
...
struct KeychainSecretsStore: SecretsStoring {
    ...
    init(service: String = "com.tylerabitbol.libra.secrets") {
